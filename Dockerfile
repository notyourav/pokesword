...
RUN wget https://releases.llvm.org/5.0.1/clang+llvm-5.0.1-x86_64-linux-gnu-debian8.tar.xz && \
    tar xf clang+llvm-5.0.1-x86_64-linux-gnu-debian8.tar.xz && \
    rm clang+llvm-5.0.1-x86_64-linux-gnu-debian8.tar.xz && \
    mv clang+llvm-5.0.1-x86_64-linux-gnu-debian8 /opt/clang-5.0.1

ENV POKESWORD_CLANG=/opt/clang-5.0.1
